...
class LedMainPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.label.grid(column=2, row=0, columnspan=2, sticky="n", pady=5, padx=5)
